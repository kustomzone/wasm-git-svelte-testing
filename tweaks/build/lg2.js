...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 127584,
    DYNAMIC_BASE = 5370464,
    DYNAMICTOP_PTR = 127424;
...
var ASM_CONSTS = {
  93333: function($0, $1) {const url = UTF8ToString($0); return Module.emscriptenhttpconnect(url, $1);},  
 93413: function($0, $1, $2) {return Module.emscriptenhttpread($0, $1, $2);},  
 93463: function($0, $1) {const url = UTF8ToString($0); return Module.emscriptenhttpconnect(url, $1, 'POST', { 'Content-Type': url.indexOf('git-upload-pack') > 0 ? 'application/x-git-upload-pack-request' : 'application/x-git-receive-pack-request' });},  
 93692: function($0, $1, $2) {return Module.emscriptenhttpwrite($0, $1, $2);}
};
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=127440;
  
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 127488, 4), 127488);
...
var asmGlobalArg = {};
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__clock_gettime": ___clock_gettime, "__handle_stack_overflow": ___handle_stack_overflow, "__sys_access": ___sys_access, "__sys_chmod": ___sys_chmod, "__sys_fcntl64": ___sys_fcntl64, "__sys_fstat64": ___sys_fstat64, "__sys_ftruncate64": ___sys_ftruncate64, "__sys_getdents64": ___sys_getdents64, "__sys_geteuid32": ___sys_geteuid32, "__sys_getuid32": ___sys_getuid32, "__sys_link": ___sys_link, "__sys_lstat64": ___sys_lstat64, "__sys_mkdir": ___sys_mkdir, "__sys_mmap2": ___sys_mmap2, "__sys_munmap": ___sys_munmap, "__sys_open": ___sys_open, "__sys_read": ___sys_read, "__sys_readlink": ___sys_readlink, "__sys_rename": ___sys_rename, "__sys_rmdir": ___sys_rmdir, "__sys_socketcall": ___sys_socketcall, "__sys_stat64": ___sys_stat64, "__sys_symlink": ___sys_symlink, "__sys_umask": ___sys_umask, "__sys_unlink": ___sys_unlink, "abort": _abort, "clock_gettime": _clock_gettime, "ctime": _ctime, "difftime": _difftime, "emscripten_asm_const_iii": _emscripten_asm_const_iii, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_fdstat_get": _fd_fdstat_get, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_sync": _fd_sync, "fd_write": _fd_write, "gai_strerror": _gai_strerror, "getaddrinfo": _getaddrinfo, "getpwuid_r": _getpwuid_r, "gettimeofday": _gettimeofday, "gmtime": _gmtime, "gmtime_r": _gmtime_r, "localtime_r": _localtime_r, "memory": wasmMemory, "mktime": _mktime, "nanosleep": _nanosleep, "setTempRet0": _setTempRet0, "strftime": _strftime, "sysconf": _sysconf, "table": wasmTable, "time": _time, "utimes": _utimes };
var asm = createWasm();
/** @type {function(...*):?} */
...
if(ENVIRONMENT_IS_WORKER || ENVIRONMENT_IS_WEB) {
    Object.assign(Module, {
        emscriptenhttpconnect: function(url, buffersize, method, headers) {
            ...
            xhr.overrideMimeType('text/plain; charset=x-user-defined');
            // xhr.responseType = 'arraybuffer'; // mrh
        ...
        emscriptenhttpread: function(connectionNo, buffer, buffersize) { 
            ...
            let responseChunk;
            if (Number.isNaN(bytes_read)) { // mrh try to get round connection.xhr.response.byteLength not defined 
              if (connection.xhr.status === 200) {
                var buf = new ArrayBuffer(connection.xhr.response.length);
                responseChunk = new Uint8Array(buf);
            
                for (var i=0, strLen=connection.xhr.response.length; i<strLen; i++) {
                  responseChunk[i] = connection.xhr.response.charCodeAt(i);
                }
              }
              bytes_read = connection.xhr.responseText.length
            } else if (bytes_read > buffersize) {
                bytes_read = buffersize;
            }
            if (responseChunk === undefined ) {
              responseChunk = new Uint8Array(connection.xhr.response, connection.resultbufferpointer, bytes_read);
            }
